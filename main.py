...
output_list = np.concatenate((R.reshape([-1,1]),L.reshape([-1,1]),M.reshape([-1,1]),T.reshape([-1,1]),rho_s.reshape([-1,1])),axis=1)

np.savetxt('alpha_2.5e-7_50.txt', output_list, delimiter=',', header='R, L, M, T, rho surface')
