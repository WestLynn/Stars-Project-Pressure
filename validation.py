...
for file_name in files:
    ...
    exp = file_name.split('Tpp')[1].split('_')[1]
...
fig1.savefig('./plots/HR_validation.png',dpi=200)
fig2.savefig('./plots/ML_validation.png',dpi=200)
fig3.savefig('./plots/MR_validation.png',dpi=200)
